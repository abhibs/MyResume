...
@section('content')
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Admin Review</div>
            <div class="ps-3">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="post" action="{{ route('review-store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                            <h6 class="mb-0">Company Logo Image</h6>
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" name="company"
                                                class="form-control @error('company') is-invalid @enderror" id=""
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                            <h6 class="mb-0">CEO Name</h6>
                                        </div>
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" name="ceo"
                                                class="form-control @error('ceo') is-invalid @enderror" id=""
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                            <h6 class="mb-0">Review Status</h6>
                                        </div>
                                        <div class="col-sm-9 text-secondary">
                                            <label for="chkYes">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="submit" class="btn btn-primary px-4" value="Add Review" />
                                        </div>
                                    </div>
                            </div>
